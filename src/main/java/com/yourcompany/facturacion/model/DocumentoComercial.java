...
import com.yourcompany.facturacion.calculadores.*;
...
abstract public class DocumentoComercial extends Identificable {
   ...
   @Column(length=6)
   @DefaultValueCalculator(value=CalculadoSiguienteNumeroParaAnio.class,
   ...
   @NoCreate @NoModify  
   @DescriptionsList(descriptionProperties="numero, nombre") 
   Cliente cliente;
